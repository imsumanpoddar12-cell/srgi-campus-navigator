...
7. **विवेक सरोज (Core Member - B.Tech CSE A)**
   • शहर: प्रतापगढ़, उत्तर प्रदेश | ईमेल: viveksaroj7598@gmail.com
...
• **श्री लक्ष्मीकांत:** क्वार्डिनेटर (Coordinator) एवं इंजीनियरिंग मैथमेटिक्स फैकल्टी

💻 **CSE Section A फैकल्टी लिस्ट:**
• **श्री प्रशांत बाजपेयी:** HOD (CSE)
• **श्री लक्ष्मीकांत:** Quardinator & Maths (इंजीनियरिंग गणित)
...
• **श्री मनोज कुमार वैश्य:** Engineering Mathematics (MATHS)
• **श्री आकाश श्रीवास्तव:** Programming for Problem Solving - PL(PPS)
• **डॉ. अंशुमान प्रकाश सिंह:** Electronics & Communication (EC)
• **डॉ. आर.बी. सिंह:** Engineering Chemistry (CHEM)
• **इंजी. अवनीश शुक्ला:** Mechanical Engineering (ME)
• **श्री राजीव कुमार मिश्रा:** Deputy HOD, Language Lab & PCTW
• **श्री लवकुश मिश्रा:** Personality Development (PD)

📌 *नोट: फैकल्टीज के ऑफिशियल संपर्क नंबर देखने के लिए कृपया मुख्य इंटरफ़ेस पर 'Faculties & Schedule' सेक्शन देखें।*`;
  }
  ...
  if (
    ...
    return `🎥 **SRGI के ऑफिशियल कैंपस वीडियो वॉकथ्रू (23 वीडियो उपलब्ध):**
...
4. **गेट 1 से मेन कैंपस प्रवेश**
5. **मेन गेट से ब्लॉक C मेन गेट तक रास्ता**
6. **ब्लॉक C मुख्य प्रवेश द्वार व पोर्च**
7. **ब्लॉक C बाईं सीढ़ियों से डायरेक्ट एंट्री**
8. **ब्लॉक C ग्राउंड से 2nd फ्लोर (बाएं सीढ़ियों से)**
9. **ब्लॉक C 2nd फ्लोर (CSE Section A, B, C व HOD ऑफिस)**
10. **ब्लॉक C 2nd फ्लोर राइट साइड विंग**
11. **ब्लॉक C 2nd फ्लोर से ग्राउंड फ्लोर नीचे उतरना**
12. **ब्लॉक C फ्लोर 2 से फ्लोर 3 (3rd Floor) सीढ़ियों का रास्ता**
13. **ब्लॉक C फ्लोर 1 से फ्लोर 3 (दाएं सीढ़ियों से)**
...
👉 यह सभी वीडियो आप नए 'Campus Videos' सेक्शन और 'Camera Detector & Videos' में सीधे प्ले कर सकते हैं!`;
  }
...
• **एडमिन टीम:** सुमन कुमार (बिहार), विवेक साहनी (कुशीनगर), प्रांजल मौर्या (वाराणसी), रोशन कुमार भारती (मऊ), रिजवान खान (महराजगंज), अविनाश प्रजापति (महराजगंज), विवेक सरोज (प्रतापगढ़)।
• **23 कैंपस वीडियो वॉकथ्रू:** Campus Videos सेक्शन व Camera Detector में उपलब्ध हैं।
