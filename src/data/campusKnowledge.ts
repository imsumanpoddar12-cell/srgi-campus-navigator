...
1. **गेट 1 से मेन कैंपस एंट्री:** कॉलेज गेट 1 से 65 एकड़ कैंपस का मुख्य मार्ग।
2. **मेन गेट से ब्लॉक C मुख्य गेट:** Gate 1 से Block C तक का सीधा वॉकथ्रू।
3. **ब्लॉक C मुख्य प्रवेश द्वार व लॉबी:** फ्रंट पोर्च और ग्राउंड फ्लोर।
4. **ब्लॉक C बाईं सीढ़ियों वाले गेट से एंट्री:** साइड गेट से बाईं सीढ़ी तक का शॉर्टकट।
...
👉 यह सभी वीडियो आप मेन स्क्रीन (Home) और **'Camera Detector & Videos'** टैब में सीधे प्ले कर सकते हैं!`;
  }
